...
NOT_NAMES = ["I", "Am", "Hello", "Hi", "My", "Name", "My Name", "Is", "Siggy", "Good", "Evening", "Morning", "Day", "Mr", "Mrs", "Miss", "Dr"]
...
POS_SUBJECTS = [
    "i", "me", "someone", "he", "she", "him", "her", "friend", "parent", "mum", "mother", "dad", "father", "other", "car"]

POS_CLIENT_SUBJECTS = [
    "I", "I'm", "me"]

POS_SOMEONE_SUBJECTS = [
    "he", "him", "his", "she", "her", "friend", "parent", "mum", "mother", "dad", "father", "brother", "sister"]
...
REQUEST_POST_ANALYSIS_OPTION = [
    "Seems like I've deducted a meaning for your dream. But before we analysis, would you like to: provie another dream or get analysis?",
    "Would you like to.. A) Provide 'new dream' B) 'get analyse'"
]

NO_OPTION = ["Sorry, didn't catch that. again. Whould you like to : More info, new dream, get analysis"]
